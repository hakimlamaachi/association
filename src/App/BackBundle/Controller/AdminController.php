...
use App\BackBundle\Entity\Admin;
use App\BackBundle\Form\AdminType;
...
class AdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBackBundle:Admin')->findAll();

        return $this->render('AppBackBundle:Admin:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AppBackBundle:Admin:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBackBundle:Admin')->find($id);
        ...
        return $this->render('AppBackBundle:Admin:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AppBackBundle:Admin:edit.html.twig', array(
            'entity'      => $entity,
